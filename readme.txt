...
= Как использовать? =
* автоматически добавляет нужные классы изображениям в записях и страницах, а так же в комментариях.
...
<code><a class="fancybx iframe" href="http://www.youtube.com/embed/L9szn1QQfas?autoplay=1">Youtube (iframe)</a></code>
...
<code><a class="fancybx iframe" href="http://maps.google.com/?output=embed&amp;f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=London+Eye,+County+Hall,+Westminster+Bridge+Road,+London,+United+Kingdom&amp;hl=lv&amp;ll=51.504155,-0.117749&amp;spn=0.00571,0.016512&amp;sll=56.879635,24.603189&amp;sspn=10.280244,33.815918&amp;vpsrc=6&amp;hq=London+Eye&amp;radius=15000&amp;t=h&amp;z=17">Google maps (iframe)</a></code>
...
- Реализация передачи параметров в iframe (не картинки, а только видео и карта) с помощью html5 атрибутов <code>data-width="значение"</code> <code>data-height="значение"</code> (пиксели или %)


= Какие еще возможности присутствуют? =
- Формирование нонстоп ютуб галереи с автозапуском:
<code><a class="fancybx iframe" href="http://www.youtube.com/embed/Pn0w7vciQCE?playlist=9BMwcO6_hyA,TR3Vdo5etCQ,-0kcet4aPpQ,43vfvIwK9iE,IfB_K4RGtDo,KL7Z4RIosrI,oVLe77sKiS0,_OLUSELxFok,vkIzfG48HTY,JE8s3wbb1_0,aySmGUxq-qo&amp;autoplay=1">Video #3 playlist</a></code>

- и возможность запускать Swf файлы (флеш игры) - но это официально не поддерживается. т.к. не гарантируется полноценная работа:
<code><a href="/wp-content/uploads/ваша-игра.swf">Game not over</a></code>


p.s. Важное замечание - на дворе 17-й год, а этот дедушка-скрипт очень давний...
К чему я? Ну то, что я заморозил разработку данного допа. Возможно вы выявите какие-либо баги на мобильных девайсах - а у меня подобных девайсов нет...
В общем предлагаю познакомится с отличным решением от меня и Дмитрия Семёнова - доп <a href="https://codeseller.ru/products/magnific-popup-recall/" target="_blank">Magnific Popup Recall</a>  - Увеличиваем изображения. Скрипт Magnific Popup от Дмитрия Семёнова
- да его возможности скромней, но он отлично работает и увеличивает высокие изображения, позволяя их рассмотреть в деталях. Крайне идеален для инфоргафики и "длиннопостов", и работает "шустрей"
Естественно отключайте "Zoom Image" если активировали "Magnific Popup Recall" - на сайте не должно работать плагинов или дополнений с одинаковым функционалом.
